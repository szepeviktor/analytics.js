(function () {
    ...
    var oc = function () {
        ...
        ge = function (a, b, c) {
            1 <= 100 * Math.random() || G("?") || (a = ["t=error", "_e=" + a, "_v=j58", "sr=1"], b && a.push("_f=" +
        ...
        na = function (a, b, c) {
            if (!a || 1 > a.length) J(12);
                ...
                for (var d = [], e = 0; e < a.length; e++) {
                    ...
                    var l = ca.shift();
                    ("GA1" == l ||
                        "1" == l) && 1 < ca.length ? (g = ca.shift().split("-"), 1 == g.length && (g[1] = "1"), g[0] *=
                        1, g[1] *= 1, ca = {
                            H: g,
                            s: ca.join(".")
                        }) : ca = kd.test(g) ? {
    ...
    function pa(a, b) {
        var c = new Date,
            d = O.navigator;
        return La([a, d.userAgent, d.language || "", c.getTimezoneOffset(), c.getYear(), c.getDate(), c.getHours(),
            c.getMinutes() + b].join("."))
    }
    var Dc = function (a) {
        J(48);
    ...
    var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/,
        ...
        Jc = function (a, b) {
            ...
            if (a.get(Hd)) a: if (c = a.get(cc), d = E(M.location[c ? "href" : "search"], "_ga"))
                if (a.get(bc))
                    if (c = d.indexOf("."), -1 == c) J(22);
                        ...
                        g = g.substring(c + 1);
                        if ("1" == e) {
                            if (c = g, d != Ic(c, 0) && d != Ic(c, -1) && d != Ic(c, -2) && d != pa(c, 0) && d !=
                                pa(c, -1) &&
                                d != pa(c, -2)) {
                                J(23);
                                break a
                            ...
                            e = g.substring(0, c);
                            c = g.substring(c + 1);
                            if (d != Ic(e + c, 0) && d != Ic(e + c, -1) && d != Ic(e + c, -2) && d != pa(e + c,
                                    0) && d != pa(e + c, -1) && d != pa(e + c, -2)) {
                                J(53);
                                break a
                            }
                            J(2);
            ...
            a.get(ja) && !a.get(I) && (J(3), a.data.set(I, ra()));
            mc(a)
        },
        Kc = function (a) {
            var b =
    ...
    N.create = function (a) {
        ...
        a: {
            if (b[Kd])
                if (J(67), Ab) b[Q] || (b[Q] = Ab);
                else {
                    var d = String(b[W] || xa());
                    var e = String(b[Yb] || "/"),
                        g = Ca(String(b[U] || "_ga"));
                    d = na(g, d, e);
                    if ((!d || jd.test(d) || kd.test(d)) && tc(ic, String(b[Na]))) {
                        d = !0;
                        break a
                    }
                }
